...
def train():
    ...
    print(f"Training Double DQN on {device}...")
    ...
    # Save model
    torch.save(policy_net.state_dict(), 'double_dqn_cartpole.pth')
    print("Model saved to double_dqn_cartpole.pth")

    # Plot results
    plt.figure(figsize=(10, 5))
    plt.plot(episode_rewards)
    plt.title('Double DQN Training Rewards (CartPole-v1)')
    plt.xlabel('Episode')
    plt.ylabel('Total Reward')
    plt.savefig('double_dqn_training.png')
    print("Training plot saved to double_dqn_training.png")
